...
minetest.override_item("", {
	...
	tool_capabilities = {
		...
		max_drop_level = 50,
		groupcaps = {
			crumbly = {times={[1]=1.00}, uses=1, maxlevel=1000},
			cracky = {times={[1]=10.00}, uses=1, maxlevel=1000},
			snappy = {times={[1]=0.50}, uses=1, maxlevel=1000},
			oddly_breakable_by_hand = {times={[1]=1.00}, uses=1, maxlevel=1000},
			choppy = {times={[1]=5.00}, uses=1, maxlevel=1000}
		},
